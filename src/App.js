...
axios.defaults.baseURL = 'https://backendinternarea.onrender.com';
...
const App = () => {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post('https://backendinternarea.onrender.com/login', { userId, email });
  ...
  const handleOtpVerify = async () => {
    try {
      const response = await axios.post('https://backendinternarea.onrender.com/verifyotp', { loginId, otp });
      setMessage(response.data.message);
